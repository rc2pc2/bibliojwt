...
public interface RefreshTokenRepository extends JpaRepository<RefreshToken, Long> {
       ...
       /**
        * Trova il refresh token attivo più vecchio di un utente.
        *
        * UTILIZZO:
        * - Limitare numero massimo di sessioni simultanee
        * - Statistiche utente
        *
        * PERFORMANCE:
        * - Evitare di caricare in memoria tutti i token.
        * - Evitare di eseguire sorting in memoria.
        * - Riduce leggermente carico su DB e memoria.
        * - Riduce code complexity.
        *
        * @param user
        * @param now
        * @return
       ...
       @Query("SELECT rt FROM RefreshToken rt"
                     ...
                     + " ORDER BY rt.createdAt ASC LIMIT 1")
